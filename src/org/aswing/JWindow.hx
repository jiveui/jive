 ...
 * just do it with setting a new `LayoutManager` to layout them, normally if you want to
 ...
 */
@:event("WindowEvent.WINDOW_ACTIVATED", "Dispatched when the window be set actived from not being actived")
@:event("WindowEvent.WINDOW_DEACTIVATED", "Dispatched when the window be set not actived from being actived")
class JWindow extends JPopup{

	/**
	 * The content pane of this window.
	 */
	public var content(get, set): Container;
	private function get_content(): Container { return getContentPane(); }
	private function set_content(v: Container): Container { setContentPane(v); return v; }

	/**
	 * Whether or not this window will be set to active when user interactive
	 * the UI. Default value is true.
	 *
	 ...
	 */
	public var activable(get, set): Bool;
	private var _activable:Bool;
	private function get_activable(): Bool { return isActivable(); }
	private function set_activable(v: Bool): Bool { setActivable(v); return v; }
	 ...
	 */
	public var actived(get, set): Bool;
	private var _actived:Bool;
	private function get_actived(): Bool { return isActive(); }
	private function set_actived(v: Bool): Bool { setActive(v); return v; }
