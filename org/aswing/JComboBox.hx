...
class JComboBox extends Component  implements EditableComponent implements bindx.IBindable {
    ...
    **/
	...
	public function setSelectedItem(item:Dynamic, programmatic:Bool=true):Void{
        ...
        Bind.notify(this.selectedItem, null, selectedItem);
        Bind.notify(this.selectedIndex, -1, selectedIndex);
