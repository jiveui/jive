...
class JList extends Container  implements LayoutManager implements Viewportable implements ListDataListener implements bindx.IBindable{
    ...
    **/
    ...
    private function __selectionListener(e:SelectionEvent):Void{
        bindx.Bind.notify(this.selectedIndex, null, this.selectedIndex);
